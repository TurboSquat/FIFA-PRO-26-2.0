const teams2014_data = {
  ...
  'B': {
    teams: [
      ...
      { name: 'Países Baixos', players: ['Jasper Cillessen','Daryl Janmaat','Stefan de Vrij','Ron Vlaar','Bruno Martins Indi','Daley Blind','Jordy Clasie','Nigel de Jong','Rafael van der Vaart','Wesley Sneijder','Arjen Robben','Memphis Depay','Dirk Kuyt','Jeremain Lens','Klaas-Jan Huntelaar','Robin van Persie'] },
  ...
  'C': {
    teams: [
      ...
      { name: 'Costa do Marfim', players: ['Boubacar Barry','Kolo Toure','Serge Aurier','Souleymane Bamba','Arthur Boka','Benjamin Angoua','Didier Zokora','Yaya Toure','Cheick Tiote','Jean-Jacques Gosso','Serey Die','Romaric','Gervinho','Salomon Kalou','Wilfried Bony','Lacina Traore','Didier Drogba'] },
  ...
  'D': {
    teams: [
      { name: 'Uruguai', players: ['Fernando Muslera','Diego Lugano','Diego Godin','Maxi Pereira','Martín Cáceres','Alvaro Pereira','Walter Gargano','Egidio Arevalo Rios','Diego Perez','Alvaro Gonzalez','Cristian Rodriguez','Gaston Ramirez','Cristhian Stuani','Abel Hernandez','Diego Forlan','Edinson Cavani','Luis Suárez'] },
      { name: 'Costa Rica', players: ['Keylor Navas','Giancarlo Gonzalez','Michael Umaña','Cristian Gamboa','Johnny Acosta','Junior Diaz','Roy Miller','Ariel Rodriguez','Christian Bolanos','Jose Miguel Cubero','Celso Borges','Michael Barrantes','Yeltsin Tejeda','Diego Calvo','Bryan Ruiz','Joel Campbell','Alvaro Saborio'] },
  ...
  'E': {
    teams: [
      { name: 'Suíça', players: ['Diego Benaglio','Stephan Lichtsteiner','Ricardo Rodriguez','Steve von Bergen','Fabian Schär','Philippe Senderos','Johan Djourou','Tranquillo Barnetta','Gökhan Inler','Valon Behrami','Blerim Džemaili','Granit Xhaka','Valentin Stocker','Xherdan Shaqiri','Admir Mehmedi','Eren Derdiyok','Haris Seferović'] },
      ...
      { name: 'Honduras', players: ['Noel Valladares','Emilio Izaguirre','Víctor Bernárdez','Maynor Figueroa','Juan Carlos Garcia','Brayan Beckeles','Jorge Claros','Arnold Peralta','Boniek Garcia','Roger Espinoza','Luis Garrido','Wilson Palacios','Andy Najar','Jerry Palacios','Marvin Chávez','Jerry Bengtson','Carlo Costly'] }
    ]
  },
  'F': {
    teams: [
      ...
      { name: 'Nigéria', players: ['Vincent Enyeama','Joseph Yobo','Efe Ambrose','Godfrey Oboabona','Elderson Echiejile','Azubuike Egwuekwe','Kenneth Omeruo','John Ogu','John Obi Mikel','Ogenyi Onazi','Sunday Mba','Victor Moses','Nnamdi Oduamadi','Ahmed Musa','Ideye Brown','Shola Ameobi','Emmanuel Emenike'] }
    ]
  },
  'G': {
    teams: [
      ...
      { name: 'Portugal', players: ['Rui Patrício','Pepe','Bruno Alves','João Pereira','Fábio Coentrão','Ricardo Costa','Antunes','Josué','Miguel Veloso','João Moutinho','Raul Meireles','William Carvalho','Nani','Silvestre Varela','Cristiano Ronaldo','Hélder Postiga','Hugo Almeida'] },
      ...
      { name: 'Estados Unidos', players: ['Tim Howard','Geoff Cameron','Omar Gonzalez','Clarence Goodson','Matt Besler','Fabian Johnson','DaMarcus Beasley','Jermaine Jones','Michael Bradley','Brad Evans','Graham Zusi','Mix Diskerud','Clint Dempsey','Aron Johannsson','Landon Donovan','Eddie Johnson','Jozy Altidore'] }
    ]
  },
  'H': {
    teams: [
      ...
      { name: 'Argélia', players: ['Raïs M\'Bolhi','Madjid Bougherra','Carl Medjani','Adlène Guedioura','Djamel Mesbah','Mehdi Mostefa','Faouzi Ghoulam','Essaid Belkalem','Hassan Yebda','Mehdi Lacen','Yacine Brahimi','Saphir Taïder','Sofiane Feghouli','Rafik Djebbour','Nabil Ghilas','El Arbi Soudani','Islam Slimani'] },
